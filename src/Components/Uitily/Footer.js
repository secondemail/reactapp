...
const Footer = () => {
    return (
        <div className="footer-background footer mt-3 pt-2" style={{ maxHeight: "50px" }}>
                ...
                <Row className="d-flex justify-content-between align-items-center">
                    ...
                    <Col
                        ...
                        <div className="d-flex pt-3 mx-2">
                            ...
                            <p className="footer-phone">01009891587</p>
                        </div>
            ...
            <div style={{backgroundColor:"#212529",color:"white",fontFamily:"cursive"}} className='me text-center p-2'>
                <h6> made with love by kareem elmohammady </h6>
            </div>
        </div>
    )
}
