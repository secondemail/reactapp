...
import AdminAddCoponPage from "./Page/Admin/AdminAddCoponPage";
import AdminEditCopon from "./Components/Admin/AdminEditCopon";
...
import ContainerProductsPage from "./Page/Products/ContainerProductsPage";
import BrandProductsPage from "./Page/Products/BrandProductsPage";
function App() {
    ...
    <div className="font" >
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/products/category/:id" element={<ContainerProductsPage />} />
          <Route path="/products/brand/:id" element={<BrandProductsPage />} />
          ...
          <Route element={<ProtectedRoute auth={isAdmin} />}>
            ...
            <Route path="/admin/add-copon" element={<AdminAddCoponPage />} />
            <Route path="/admin/edit-copon/:id" element={<AdminEditCopon />} />
          ...
          <Route element={<ProtectedRoute auth={isUser} />}>
            ...
            <Route path="/user/edit-user/:id" element={<UpdateUser />} />
          </Route>
